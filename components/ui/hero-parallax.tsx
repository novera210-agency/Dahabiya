...
export const ProductCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 h-full w-full opacity-0 group-hover/product:opacity-80 bg-[#1B2785] pointer-events-none rounded-2xl transition-opacity duration-300" />
      ...
      <div className="absolute bottom-4 right-4 opacity-0 group-hover/product:opacity-100 transition-opacity duration-300">
        <span className="text-[#F5A623] text-xs font-medium tracking-widest uppercase">
          Explore →
        </span>
      </div>
    </motion.div>
