  ...
  return (
    <section className="py-24 px-4 bg-[#FDFAF5] relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-center gap-6 [mask-image:linear-gradient(to_bottom,transparent,black_15%,black_85%,transparent)] max-h-[520px] sm:max-h-[720px] overflow-hidden">
